...
parser.add_argument('--output_path', type=str, default='LLaMA2-Chinese-13B-Chat_result.json')
parser.add_argument('--model_path', type=str, default='FlagAlpha/Llama2-Chinese-13b-Chat')
...
for i,_ in enumerate(tqdm(data_test)):
    ...
    data_test[i]["LLM_name"] = "LLaMA2-Chinese-13B-Chat"
