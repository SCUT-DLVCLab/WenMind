...
parser.add_argument('--output_path', type=str, default='Qwen1.5-0.5B-Chat_result.json')
parser.add_argument('--model_path', type=str, default='Qwen/Qwen1.5-0.5B-Chat')
...
for i,_ in enumerate(tqdm(data_test)):
    ...
    data_test[i]["LLM_name"] = "Qwen1.5-0.5B-Chat"
