...
parser.add_argument('--output_path', type=str, default='LLaMA3-Chinese-8B-Chat_result.json')
parser.add_argument('--model_path', type=str, default='FlagAlpha/Llama3-Chinese-8B-Instruct')
...
for i,_ in enumerate(tqdm(data_test)):
    ...
    data_test[i]["LLM_name"] = "LLaMA3-Chinese-8B-Chat"
