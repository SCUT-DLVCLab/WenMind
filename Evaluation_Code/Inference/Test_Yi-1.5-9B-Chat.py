...
parser.add_argument('--output_path', type=str, default='Yi-1.5-9B-Chat_result.json')
parser.add_argument('--model_path', type=str, default='01-ai/Yi-1.5-9B-Chat')
...
for i,_ in enumerate(tqdm(data_test)):
    ...
    data_test[i]["LLM_name"] = "Yi-1.5-9B-Chat"
