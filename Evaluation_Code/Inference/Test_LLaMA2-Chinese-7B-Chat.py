...
parser.add_argument('--output_path', type=str, default='LLaMA2-Chinese-7B-Chat_result.json')
parser.add_argument('--model_path', type=str, default='FlagAlpha/Llama2-Chinese-7b-Chat')
...
for i,_ in enumerate(tqdm(data_test)):
    ...
    data_test[i]["LLM_name"] = "LLaMA2-Chinese-7B-Chat"
