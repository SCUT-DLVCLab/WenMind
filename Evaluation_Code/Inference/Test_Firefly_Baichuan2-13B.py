...
parser.add_argument('--output_path', type=str, default='Firefly-Baichuan2-13B_result.json')
parser.add_argument('--model_path', type=str, default='YeungNLP/firefly-baichuan2-13b')
...
for i,_ in enumerate(tqdm(data_test)):
    ...
    data_test[i]["LLM_name"] = "Firefly-Baichuan2-13B"
